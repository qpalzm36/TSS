...
def main():
    ...
    report = {
        ...
        "retrieval_impact_analysis": {
            ...
            "quadrants": {
                "high_adherence_correct (TP)": f"{tp} ({tp/problems_with_retrieval:.2%})" if problems_with_retrieval > 0 else f"{tp} (N/A)",
                "high_adherence_incorrect (FP)": f"{fp} ({fp/problems_with_retrieval:.2%})" if problems_with_retrieval > 0 else f"{fp} (N/A)",
                "low_adherence_correct (FN)": f"{retrieval_impact['low_adherence_correct']} ({retrieval_impact['low_adherence_correct']/problems_with_retrieval:.2%})" if problems_with_retrieval > 0 else f"{retrieval_impact['low_adherence_correct']} (N/A)",
                "low_adherence_incorrect (TN)": f"{retrieval_impact['low_adherence_incorrect']} ({retrieval_impact['low_adherence_incorrect']/problems_with_retrieval:.2%})" if problems_with_retrieval > 0 else f"{retrieval_impact['low_adherence_incorrect']} (N/A)"
            }
        }
    }
