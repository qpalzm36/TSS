...
from verl.utils.reward_score import tss_single_stream_score, qa_em
from verl.trainer.ppo.ray_trainer import RayPPOTrainer
import re
import numpy as np

def _select_rm_score_fn(data_source):
    if data_source == 'math_tss':
        return tss_single_stream_score.compute_score
    elif data_source == 'math_standard_test':

        return qa_em.compute_score_em
    elif data_source in ['nq', 'triviaqa', 'popqa', 'web_questions', 'hotpotqa', '2wikimultihopqa', 'musique', 'bamboogle', 'strategyqa']:
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            if data_source == 'math_tss':
                ...
                score, sub_scores_dict = compute_score_fn(
            ...
            all_sub_scores.append(sub_scores_dict)
        ...
        data.non_tensor_batch['sub_scores'] = np.array(all_sub_scores, dtype=object)
