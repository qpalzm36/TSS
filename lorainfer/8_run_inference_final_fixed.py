...
if __name__ == "__main__":
    ...
    parser.add_argument("--generator_model_path", type=str, default="/data/yangcheng/aaai/generator_finetuned_ex/Qwen-2.5-3B-Instruct-lora", help="生成器模型路径")
    ...
    parser.add_argument("--output_log_path", type=str, default="/data/yangcheng/aaai/result-lf/resultqwen3blora.jsonl", help="输出日志路径")
